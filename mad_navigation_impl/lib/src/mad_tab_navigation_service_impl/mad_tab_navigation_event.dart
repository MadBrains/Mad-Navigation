...
final class NavigationSelectTabByUserEvent extends MadNavigationEvent
    with Stringify {
...
final class NavigationPushTabRouteEvent extends MadNavigationEvent
    with Stringify {
...
final class NavigationReplaceTabRouteEvent extends MadNavigationEvent
    with Stringify {
...
final class NavigationPopAndPushTabRouteEvent extends MadNavigationEvent
    with Stringify {
...
final class NavigationPushAndRemoveUntilForTabStackEvent
    extends MadNavigationEvent with Stringify {
  const NavigationPushAndRemoveUntilForTabStackEvent({
    required this.route,
...
final class NavigationResetTabStackEvent extends MadNavigationEvent
    with Stringify {
  const NavigationResetTabStackEvent({required this.tab, required this.stack});
