...
class MadTabNavigationServiceImpl<T extends MadTabNavigationState> extends MadNavigationServiceImpl<T>
    with _TabNavigatorBlocMixin {
  ...
  void setEventHandlers() {
    onAsync<NavigationSelectTabByUserEvent>((NavigationSelectTabByUserEvent event) async* {
    ...
    onAsync<NavigationPushTabRouteEvent>((NavigationPushTabRouteEvent event) async* {
    ...
    onAsync<NavigationPopAndPushTabRouteEvent>((NavigationPopAndPushTabRouteEvent event) async* {
    ...
    onAsync<NavigationReplaceTabRouteEvent>((NavigationReplaceTabRouteEvent event) async* {
      yield state._replaceInTabStack(oldPage: event.oldRoute, newPage: event.newRoute);
    });
    ...
    onAsync<NavigationResetTabStackEvent>((NavigationResetTabStackEvent event) async* {
      yield state._saveTabStack(event.tab, event.stack);
    });
    onAsync<NavigationResetJumpToTopOnRootPageEvent>((NavigationResetJumpToTopOnRootPageEvent event) async* {
